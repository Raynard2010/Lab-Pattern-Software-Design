<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/navbar.Master" AutoEventWireup="true" CodeBehind="AddCardPage.aspx.cs" Inherits="ProjectLab.Views.AddCardPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Button ID="BtnAdd" Text="Add" OnClick="BtnAdd_Click" runat="server" /><br />
